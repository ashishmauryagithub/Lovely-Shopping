    ...
    protected void btPassRec_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi "+Username+ ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:1076/RecoverPassword.aspx?Uid="+myGUID;
                MailMessage PassRecMail = new MailMessage("maplah666@gmail.com", ToEmailAddress);
